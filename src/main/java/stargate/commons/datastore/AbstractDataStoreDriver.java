...
public abstract class AbstractDataStoreDriver extends AbstractDriver {
    ...
    public abstract AbstractKeyValueStore getExpiringKeyValueStore(String name, Class valueClass, EnumDataStoreProperty property, TimeUnit timeunit, long timeval) throws IOException, DriverNotInitializedException;
